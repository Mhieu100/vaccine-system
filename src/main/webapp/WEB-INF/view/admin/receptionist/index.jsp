        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <h5 class="card-title">Danh sách thu ngân</h5>
            ...
            <table class="table table-hover table-bordered">
              ...
              <tbody>
              <c:forEach var="receptionist" items="${listReceptionist}" varStatus="status">
                <tr>
                  ...
                  <td><fmt:formatNumber
                          value="${receptionist.employee.salary}" type="number" groupingUsed="true" /> đ</td>
                  <td>${receptionist.employee.department} năm</td>
